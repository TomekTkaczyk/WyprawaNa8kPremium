...
namespace WyprawaNa8kPremiumTests
{
    public class NumbersListTests
    {
        ...
        public void When_arraynumbers_contains_two_numbers_whouse_sum_is_k_NumbersIsSumExist01_should_be_return_expected_result(bool expectedResult, int k, int[] numbers)
        {
        ...
        [InlineData(true, 0, new int[] { 10, -2, -2, 2, 6, 8 })]
        [InlineData(false, 1, new int[] { 10, -2, -2, 2, 6, 8 })]
        public void When_arraynumbers_contains_two_numbers_whouse_sum_is_k_NumbersIsSumExist02_should_be_return_expected_result(bool expectedResult, int k, int[] numbers)
        {
            var numbersList = new NumbersList();
        ...
        [InlineData(true, 0, new int[] { 10, -2, -2, 2, 6, 8 })]
        [InlineData(false, 1, new int[] { 10, -2, -2, 2, 6, 8 })]
        public void When_arraynumbers_contains_two_numbers_whouse_sum_is_k_NumbersIsSumExist03_should_be_return_expected_result(bool expectedResult, int k, int[] numbers)
        {
            var numbersList = new NumbersList();
